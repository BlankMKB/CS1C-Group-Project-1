 ...
 * To manually reset the database, call DeleteAllMembers() then InitializeMemberDB().
...
public:
    ...
    /*!
     * \fn operator=(const DbManager&)
     * \brief Deleted operator=
     * \param other: DbManager
     * \return DbManager
     */
