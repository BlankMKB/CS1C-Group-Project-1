...
"}"));
        ...
        salesByDayTW->setGeometry(QRect(20, 30, 281, 271));
        ...
        salesByMemberTW->setHorizontalHeaderItem(0, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        __qtablewidgetitem3->setFont(font);
        salesByMemberTW->setHorizontalHeaderItem(1, __qtablewidgetitem3);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        __qtablewidgetitem4->setFont(font);
        salesByMemberTW->setHorizontalHeaderItem(2, __qtablewidgetitem4);
        ...
        __qtablewidgetitem5->setText(QString::fromUtf8("Member Information"));
        __qtablewidgetitem5->setFont(font);
        memberInfoTW->setHorizontalHeaderItem(0, __qtablewidgetitem5);
        if (memberInfoTW->rowCount() < 5)
            memberInfoTW->setRowCount(5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        memberInfoTW->setVerticalHeaderItem(0, __qtablewidgetitem6);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        memberInfoTW->setVerticalHeaderItem(1, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        memberInfoTW->setVerticalHeaderItem(2, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        memberInfoTW->setVerticalHeaderItem(3, __qtablewidgetitem9);
        QTableWidgetItem *__qtablewidgetitem10 = new QTableWidgetItem();
        memberInfoTW->setVerticalHeaderItem(4, __qtablewidgetitem10);
        ...
        rebateInfoTW->setHorizontalHeaderItem(0, __qtablewidgetitem11);
        QTableWidgetItem *__qtablewidgetitem12 = new QTableWidgetItem();
        __qtablewidgetitem12->setText(QString::fromUtf8("Rebate Amount"));
        __qtablewidgetitem12->setFont(font);
        rebateInfoTW->setHorizontalHeaderItem(1, __qtablewidgetitem12);
        ...
        expirationInfoTW->setHorizontalHeaderItem(0, __qtablewidgetitem13);
        QTableWidgetItem *__qtablewidgetitem14 = new QTableWidgetItem();
        __qtablewidgetitem14->setText(QString::fromUtf8("Expiration Date"));
        __qtablewidgetitem14->setFont(font);
        expirationInfoTW->setHorizontalHeaderItem(1, __qtablewidgetitem14);
        ...
        frame_9->setGeometry(QRect(20, 110, 751, 331));
        frame_9->setFrameShape(QFrame::StyledPanel);
        frame_9->setFrameShadow(QFrame::Plain);
        frame_9->setLineWidth(2);
        frame_9->setMidLineWidth(3);
        memberTypeTW = new QTableWidget(frame_9);
        if (memberTypeTW->columnCount() < 2)
            memberTypeTW->setColumnCount(2);
        QTableWidgetItem *__qtablewidgetitem15 = new QTableWidgetItem();
        __qtablewidgetitem15->setFont(font);
        memberTypeTW->setHorizontalHeaderItem(0, __qtablewidgetitem15);
        QTableWidgetItem *__qtablewidgetitem16 = new QTableWidgetItem();
        memberTypeTW->setHorizontalHeaderItem(1, __qtablewidgetitem16);
        memberTypeTW->setObjectName(QString::fromUtf8("memberTypeTW"));
        memberTypeTW->setGeometry(QRect(20, 20, 271, 271));
        frame_10 = new QFrame(tab);
        frame_10->setObjectName(QString::fromUtf8("frame_10"));
        frame_10->setGeometry(QRect(20, 30, 751, 81));
        frame_10->setFrameShape(QFrame::StyledPanel);
        frame_10->setFrameShadow(QFrame::Raised);
        frame_10->setLineWidth(2);
        frame_10->setMidLineWidth(3);
        typeCB = new QComboBox(frame_10);
        typeCB->setObjectName(QString::fromUtf8("typeCB"));
        typeCB->setGeometry(QRect(10, 40, 253, 23));
        typeCB->setFont(font1);
        typeLabel = new QLabel(frame_10);
        typeLabel->setObjectName(QString::fromUtf8("typeLabel"));
        typeLabel->setGeometry(QRect(10, 10, 251, 21));
    ...
    void retranslateUi(QDialog *StoreManagerWindow)
    {
        ...
        QTableWidgetItem *___qtablewidgetitem2 = salesByMemberTW->horizontalHeaderItem(0);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("StoreManagerWindow", "Item Name", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = salesByMemberTW->horizontalHeaderItem(1);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("StoreManagerWindow", "Item Price", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = salesByMemberTW->horizontalHeaderItem(2);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("StoreManagerWindow", "Item Quantity", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem5 = memberInfoTW->verticalHeaderItem(0);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("StoreManagerWindow", "Name", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = memberInfoTW->verticalHeaderItem(1);
        ___qtablewidgetitem6->setText(QCoreApplication::translate("StoreManagerWindow", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem7 = memberInfoTW->verticalHeaderItem(2);
        ___qtablewidgetitem7->setText(QCoreApplication::translate("StoreManagerWindow", "Member Type", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = memberInfoTW->verticalHeaderItem(3);
        ___qtablewidgetitem8->setText(QCoreApplication::translate("StoreManagerWindow", "Expiration Date", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = memberInfoTW->verticalHeaderItem(4);
        ___qtablewidgetitem9->setText(QCoreApplication::translate("StoreManagerWindow", "Running Total", nullptr));
        QTableWidgetItem *___qtablewidgetitem10 = rebateInfoTW->horizontalHeaderItem(0);
        ___qtablewidgetitem10->setText(QCoreApplication::translate("StoreManagerWindow", "Member", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = expirationInfoTW->horizontalHeaderItem(0);
        ___qtablewidgetitem11->setText(QCoreApplication::translate("StoreManagerWindow", "Member", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem12 = memberTypeTW->horizontalHeaderItem(0);
        ___qtablewidgetitem12->setText(QCoreApplication::translate("StoreManagerWindow", "Members", nullptr));
        QTableWidgetItem *___qtablewidgetitem13 = memberTypeTW->horizontalHeaderItem(1);
        ___qtablewidgetitem13->setText(QCoreApplication::translate("StoreManagerWindow", "Member ID", nullptr));
        typeLabel->setText(QCoreApplication::translate("StoreManagerWindow", "Sort by type: ", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("StoreManagerWindow", "Member List", nullptr));
